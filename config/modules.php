...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'filter' => ['path' => 'App/Filters', 'generate' => true],
            'observer' => ['path' => 'App/Observers', 'generate' => true],
            'routes' => ['path' => 'routes', 'generate' => true],
            'controller' => ['path' => 'App/Http/Controllers', 'generate' => true],
            'api-controller' => ['path' => 'App/Http/Controllers/API', 'generate' => true],
            'middleware' => ['path' => 'App/Http/Middleware', 'generate' => true],
            'request' => ['path' => 'App/Http/Requests', 'generate' => true],
            'export' => ['path' => 'App/Exports', 'generate' => true],
            'import' => ['path' => 'App/Imports', 'generate' => true],
    ...
    */
    ...
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'atqiyacode'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Atqiya Suherman'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'atqiya@atqiyacode.com'),
        ],
